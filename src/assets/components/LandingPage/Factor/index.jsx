        ...
        <section className="factor">
            ...
            <div className={`card-box mt-4 ${styles.sliderContainer}`}>
                <div className="swiper-wrapper">
                    <div className={`swiper-slide ${styles.sliderItem}`}>
                        <div className="col-sm-7 col-md-7 col-lg-7 my-auto p-3">
                            ...
                            <ul id="first-swiper-slide">
                                ...
                                <li className="factor-hidden-item color-light poppins-medium font-paragraph">
                                    Lahan TPA semakin menyempit akibat tergusur
                                    oleh pengunaan lain.
                                </li>
                                <li className="factor-hidden-item color-light poppins-medium font-paragraph">
                                    Jarak TPA dan pusat sampah relatif jauh
                                    hingga waktu untuk menganggut sampah kurang
                                    efektif.
                                </li>
                                <li className="factor-hidden-item color-light poppins-medium font-paragraph">
                    ...
                    <div className={`swiper-slide ${styles.sliderItem} d-flex`}>
                        <div className="col-sm-7 col-md-7 col-lg-7 my-auto p-3">
                            <h1 className="factor-title poppins-bold font-title color-light">
                                PRODUK SEKALI PAKAI
                            </h1>
                            <p className="factor-desc font-paragraph color-light lh-base poppins-medium">
                                ...
                                mereka seringkali menggunakan bahan bahan bakar
                                fosil seperti batu bara, minyak, dan gas alam.
                                Proses pembakaran bahan bakar ini menghasilkan
                                emisi gas rumah kaca, terutama karbon dioksida
                                (CO2) dan metana (CH4)
                            </p>
                        </div>
                        <div className="col-sm-5 col-md-5 col-lg-5">
