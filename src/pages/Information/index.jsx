...
const Information = (swiper) => {
  let hudan = new Swiper(".slider-container", {
    slidesPerView: "auto",
    spaceBetween: 30,
  });
  return (
                    ...
                    <div class="swiper-wrapper d-flex">
                        ...
                        <div class="card-container d-flex flex-column">
                          ...
                          <div class="card-body">
                            <p class="font-paragraph lh-base mt-3 poppins-regular color-light">
                              ...
                              lingkungan, kesehatan manusia, dan masyarakat
                              secara umum, Sampah yang dibiarkan berserakan atau
                              dibuang sembarangan dapat mencemari tanah, air,
                              dan udara. Produk-produk kimia berbahaya dalam
                              sampah dapat merembes ke dalam tanah dan air,
                              mengkontaminasi sumber daya alam dan memengaruhi
                      ...
                      <div class="swiper-slide slider-item">
                        <div class="card-container d-flex flex-column">
                          ...
                          <div class="card-body">
                            <p class="font-paragraph lh-base mt-3 poppins-regular color-light">
                              Sampah yang berserakan menciptakan pemandangan
                              yang tidak menarik dan kotor. Ini bisa mencakup
                              tumpukan sampah di tepi jalan, pantai, taman, atau
                              daerah wisata lainnya. Kehadiran sampah yang
                              mencolok dapat mengganggu pengalaman wisatawan
                              yang mencari lingkungan yang bersih, indah, dan
                              rapi, jika berupa sampah tajam atau bahan
                              berbahaya, dapat menjadi bahaya bagi orang-orang
                      ...
                      <div class="swiper-slide slider-item">
                        <div class="card-container d-flex flex-column">
                          ...
                          <div class="card-body">
                            <p class="font-paragraph lh-base mt-3 poppins-regular color-light">
                              CO2 adalah gas rumah kaca utama yang dihasilkan
                              dari pembakaran sampah. Ketika bahan organik
                              seperti plastik, kertas, dan limbah makanan
                              terbakar, mereka melepaskan karbon dioksida ke
                              atmosfer. Karbon dioksida adalah penyebab utama
                              perubahan iklim dan pemanasan gl.obal., yang kedua
                              adalah Metana yang merupakan gas rumah kaca yang
                              lebih kuat daripada karbon dioksida dalam
                      ...
                      <div class="swiper-slide slider-item">
                        <div class="card-container d-flex flex-column">
                          ...
                          <div class="card-body">
                            <p class="font-paragraph lh-base mt-3 poppins-regular color-light">
                              Selanjutnya hasil uang yang diperoleh dari
                              penjualan barang daur ulang akan kami sumbangkan
                              pada Panti Asuhan & Orang yang membutuhkan, proses
                              pemberian hasil ini juga bisa anda lihat lebih
