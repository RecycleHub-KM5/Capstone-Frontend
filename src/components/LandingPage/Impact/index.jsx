...
const LPImpact = () => {
    return (
        <section className="impact mt-5">
            <header>
                <h1 className="impact-title poppins-bold font-title color-light text-center mt-5">
            ...
            <div className={styles.gridContainer}>
                <div className={`${styles.gridItem} ${styles.item1}`}>
                    <img
                        ...
                        className="impact-icons"
                    />
                    <h4 className={`${styles.impactHeader} font-paragraph`}>
                        / Pencemaran Lingkungan
                    </h4>
                    <h3 className="impact-desc font-paragraph color-light">
